...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('cms_task_resources')) {
        ...
        if (!Schema::hasTable('cms_resource_availability')) {
        ...
        if (Schema::hasTable('cms_workload_snapshots')) {
            ...
            if (!Schema::hasColumn('cms_workload_snapshots', 'overdue_tasks_count')) {
                Schema::table('cms_workload_snapshots', function (Blueprint $table) {
                    $table->integer('overdue_tasks_count')->default(0)->after('completed_tasks_count');
                });
            }
            if (!Schema::hasColumn('cms_workload_snapshots', 'average_completion_time_hours')) {
                Schema::table('cms_workload_snapshots', function (Blueprint $table) {
        ...
        if (Schema::hasTable('cms_tasks')) {
            ...
            if (!Schema::hasColumn('cms_tasks', 'actual_cost')) {
                Schema::table('cms_tasks', function (Blueprint $table) {
                    $table->decimal('actual_cost', 10, 2)->nullable()->after('actual_hours');
                });
            }
            if (!Schema::hasColumn('cms_tasks', 'estimated_story_points')) {
                Schema::table('cms_tasks', function (Blueprint $table) {
        ...
        // Bulk Operations Log
        if (!Schema::hasTable('cms_bulk_operations')) {
        ...
        if (Schema::hasTable('cms_tasks')) {
            ...
            if (!Schema::hasColumn('cms_tasks', 'scheduled_end')) {
                Schema::table('cms_tasks', function (Blueprint $table) {
                    $table->dateTime('scheduled_end')->nullable()->after('scheduled_start');
                });
            }
            if (!Schema::hasColumn('cms_tasks', 'duration_minutes')) {
                Schema::table('cms_tasks', function (Blueprint $table) {
        ...
        if (!Schema::hasTable('cms_task_triggers')) {
        ...
        if (!Schema::hasTable('cms_task_trigger_executions')) {
        ...
        if (!Schema::hasTable('cms_user_productivity_metrics')) {
        ...
        if (!Schema::hasTable('cms_task_completion_trends')) {
        ...
        if (Schema::hasTable('cms_task_dependencies')) {
            if (!Schema::hasColumn('cms_task_dependencies', 'lead_days')) {
                Schema::table('cms_task_dependencies', function (Blueprint $table) {
                    $table->integer('lead_days')->default(0)->after('lag_days');
                });
            }
            if (!Schema::hasColumn('cms_task_dependencies', 'is_critical_path')) {
                Schema::table('cms_task_dependencies', function (Blueprint $table) {
        ...
        // Mobile Sync Queue
        if (!Schema::hasTable('cms_mobile_sync_queue')) {
        ...
        if (!Schema::hasTable('cms_offline_changes')) {
        ...
        // What-If Scenarios
        if (Schema::hasTable('cms_planning_scenarios')) {
            ...
            if (!Schema::hasColumn('cms_planning_scenarios', 'original_state')) {
                Schema::table('cms_planning_scenarios', function (Blueprint $table) {
                    $table->json('original_state')->nullable()->after('changes_json');
                });
            }
            if (!Schema::hasColumn('cms_planning_scenarios', 'metrics_before')) {
                Schema::table('cms_planning_scenarios', function (Blueprint $table) {
                    $table->json('metrics_before')->nullable()->after('original_state');
                });
            }
            if (!Schema::hasColumn('cms_planning_scenarios', 'metrics_after')) {
                Schema::table('cms_planning_scenarios', function (Blueprint $table) {
        ...
        if (Schema::hasTable('cms_workflow_bottlenecks')) {
            ...
            if (!Schema::hasColumn('cms_workflow_bottlenecks', 'auto_detected')) {
                Schema::table('cms_workflow_bottlenecks', function (Blueprint $table) {
                    $table->boolean('auto_detected')->default(true)->after('recommendations');
                });
            }
            if (!Schema::hasColumn('cms_workflow_bottlenecks', 'detected_by')) {
                Schema::table('cms_workflow_bottlenecks', function (Blueprint $table) {
        ...
        if (Schema::hasTable('cms_task_recommendations')) {
            if (!Schema::hasColumn('cms_task_recommendations', 'category')) {
                Schema::table('cms_task_recommendations', function (Blueprint $table) {
                    $table->string('category')->default('general')->after('recommendation_type');
                });
            }
            if (!Schema::hasColumn('cms_task_recommendations', 'priority_score')) {
                Schema::table('cms_task_recommendations', function (Blueprint $table) {
                    $table->integer('priority_score')->default(50)->after('confidence_score');
                });
            }
            if (!Schema::hasColumn('cms_task_recommendations', 'expires_at')) {
                Schema::table('cms_task_recommendations', function (Blueprint $table) {
                    $table->timestamp('expires_at')->nullable()->after('status');
                });
            }
            if (!Schema::hasColumn('cms_task_recommendations', 'applied_by')) {
                Schema::table('cms_task_recommendations', function (Blueprint $table) {
                    $table->foreignId('applied_by')->nullable()->constrained('users')->onDelete('set null')->after('expires_at');
                });
            }
            if (!Schema::hasColumn('cms_task_recommendations', 'applied_at')) {
                Schema::table('cms_task_recommendations', function (Blueprint $table) {
