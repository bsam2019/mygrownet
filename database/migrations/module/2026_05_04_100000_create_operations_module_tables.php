...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('cms_workflow_stages')) {
        ...
        if (!Schema::hasTable('cms_task_logs')) {
        ...
        if (!Schema::hasTable('cms_task_issues')) {
        ...
        if (!Schema::hasTable('cms_task_checklist_templates')) {
        ...
        // Checklist Items
        if (!Schema::hasTable('cms_checklist_template_items')) {
        ...
        if (!Schema::hasTable('cms_task_checklist_responses')) {
        ...
        // Capacity Forecasts
        if (!Schema::hasTable('cms_capacity_forecasts')) {
