...
return new class extends Migration
{
    ...
    {
        // Inventory Items
        if (!Schema::hasTable('cms_inventory_items')) {
        ...
        if (!Schema::hasTable('cms_stock_movements')) {
        ...
        if (!Schema::hasTable('cms_job_inventory')) {
        ...
        // Low Stock Alerts
        if (!Schema::hasTable('cms_low_stock_alerts')) {
