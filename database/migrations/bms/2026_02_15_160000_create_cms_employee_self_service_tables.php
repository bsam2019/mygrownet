...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('cms_employee_portal_access')) {
        ...
        // Document requests
        if (!Schema::hasTable('cms_document_requests')) {
        ...
        if (!Schema::hasTable('cms_profile_update_requests')) {
        ...
        if (!Schema::hasTable('cms_announcement_recipients')) {
        ...
        if (!Schema::hasTable('cms_employee_feedback')) {
        ...
        if (!Schema::hasTable('cms_time_off_summary')) {
        ...
        if (!Schema::hasTable('cms_worker_documents')) {
