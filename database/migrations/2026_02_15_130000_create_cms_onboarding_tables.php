...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('cms_onboarding_templates')) {
        ...
        // Onboarding Tasks
        if (!Schema::hasTable('cms_onboarding_tasks')) {
        ...
        // Employee Onboarding
        if (!Schema::hasTable('cms_employee_onboarding')) {
        ...
        if (!Schema::hasTable('cms_onboarding_task_progress')) {
