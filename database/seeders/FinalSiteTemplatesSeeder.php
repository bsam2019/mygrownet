...
class FinalSiteTemplatesSeeder extends Seeder
{
    ...
    private function createEventPlanningTemplate(): void
    {
        $template = SiteTemplate::updateOrCreate(['slug' => 'elegance-events'], [
            ...
            'industry' => 'events', 'thumbnail' => 'https://images.unsplash.com/photo-1519167758481-83f29da8c2b6?w=800&q=80',
        ...
        SiteTemplatePage::create(['site_template_id' => $template->id, 'title' => 'Home', 'slug' => 'home', 'is_homepage' => true, 'show_in_nav' => true, 'sort_order' => 1,
            'content' => ['sections' => [
                ['type' => 'hero', 'content' => ['layout' => 'centered', 'title' => 'Creating Unforgettable Moments', 'subtitle' => 'Professional event planning for weddings, corporate events, and celebrations. Stress-free planning, flawless execution.', 'buttonText' => 'View Portfolio', 'buttonLink' => '/portfolio', 'secondaryButtonText' => 'Plan Your Event', 'secondaryButtonLink' => '/contact', 'backgroundImage' => 'https://images.unsplash.com/photo-1519167758481-83f29da8c2b6?w=1200&q=80', 'overlayColor' => 'gradient', 'overlayGradientFrom' => '#db2777', 'overlayGradientTo' => '#be185d', 'overlayOpacity' => 60], 'style' => ['minHeight' => 700]],
