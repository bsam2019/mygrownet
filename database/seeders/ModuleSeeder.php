...
class ModuleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $modules = [
            ...
            // GrowBuilder - Website Builder - Indigo
            [
                'id' => 'growbuilder',
                'name' => 'GrowBuilder',
                'slug' => 'growbuilder',
                'category' => 'sme',
                'description' => 'Build professional websites with AI-powered content generation',
                'icon' => '🌐',
                'color' => '#6366F1', // Indigo
                'thumbnail' => null,
                'account_types' => json_encode(['member', 'business']),
                ...
                'pwa_config' => json_encode(['enabled' => false, 'installable' => false]),
                'features' => json_encode(['notifications' => true, 'offline' => false, 'ai_content' => true]),
                'subscription_tiers' => json_encode([
                    'free' => [
                        'name' => 'Free',
                        'description' => '1 site with basic features',
                        'price' => 0,
                        'price_annual' => 0,
                        'features' => [
                            'sites' => 1,
                    ...
                    'standard' => [
                        'name' => 'Standard Site',
                        'description' => 'Per site with all features',
                        'price' => 49,
                        'price_annual' => 490,
                        'is_popular' => true,
                        'features' => [
                    ...
                    'ecommerce' => [
                        ...
                        'description' => 'Per site with products & orders',
                        'price' => 99,
                        'price_annual' => 990,
                        'features' => [
                            'sites' => 1,
            ...
            // Ubumi - Family Lineage & Health Check-In Platform - Purple
            [
                'id' => 'ubumi',
                'name' => 'Ubumi',
                'slug' => 'ubumi',
                'category' => 'personal',
                'description' => 'Family lineage tracking and health check-in platform to stay connected with family members',
                'icon' => '👨‍👩‍👧‍👦',
                'color' => '#9333EA', // Purple
                'thumbnail' => null,
                'account_types' => json_encode(['member', 'client']),
                'required_roles' => null,
                'min_user_level' => null,
                'routes' => json_encode([
                    'integrated' => '/ubumi',
