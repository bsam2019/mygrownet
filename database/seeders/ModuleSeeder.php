...
class ModuleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $modules = [
            ...
            // Ubumi - Church Management System - Purple
            [
                'id' => 'ubumi',
                'name' => 'Ubumi',
                'slug' => 'ubumi',
                'category' => 'enterprise',
                'description' => 'Complete church management system for members, events, donations, and ministry coordination',
                'icon' => '⛪',
                'color' => '#9333EA', // Purple
                'thumbnail' => null,
                'account_types' => json_encode(['business', 'member']),
