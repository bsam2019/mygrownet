...
class AdditionalSiteTemplatesSeeder extends Seeder
{
    ...
    private function createEducationTemplate(): void
    {
        ...
        SiteTemplatePage::create([
            ...
            'sort_order' => 1,
            'content' => ['sections' => [
                ['type' => 'hero', 'content' => ['layout' => 'split-right', 'title' => 'Empowering Tomorrow\'s Leaders', 'subtitle' => 'Quality education that prepares students for success in a rapidly changing world. Join Zambia\'s premier learning institution.', 'buttonText' => 'Apply Now', 'buttonLink' => '/contact', 'secondaryButtonText' => 'Our Programs', 'secondaryButtonLink' => '/programs', 'image' => 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800&q=80'], 'style' => ['backgroundColor' => '#1e293b', 'minHeight' => 600]],
