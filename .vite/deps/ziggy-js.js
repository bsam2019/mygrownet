...
var E = Date.prototype.toISOString;
var O = { addQueryPrefix: false, allowDots: false, allowEmptyArrays: false, arrayFormat: "indices", charset: "utf-8", charsetSentinel: false, delimiter: "&", encode: true, encodeDotInKeys: false, encoder: function(t3, e2, o2, n2, r2) {
...
var T = {};
var R = function(t3, e2, o2, n2, r2, i2, s2, u2, l2, c2, a2, f2, p2, y2, d2, h2, b2, g2) {
...
var I = Array.isArray;
var S = { allowDots: false, allowEmptyArrays: false, allowPrototypes: false, allowSparse: false, arrayLimit: 20, charset: "utf-8", charsetSentinel: false, comma: false, decodeDotInKeys: false, decoder: function(t3, e2, o2) {
...
}, delimiter: "&", depth: 5, duplicates: "combine", ignoreQueryPrefix: false, interpretNumericEntities: false, parameterLimit: 1e3, parseArrays: true, plainObjects: false, strictNullHandling: false };
var A = function(t3) {
...
function N(t3, e2) {
  const o2 = (function(t4) {
    ...
    if (void 0 !== t4.decodeDotInKeys && "boolean" != typeof t4.decodeDotInKeys) throw new TypeError("`decodeDotInKeys` option can only be `true` or `false`, when provided");
    if (null != t4.decoder && "function" != typeof t4.decoder) throw new TypeError("Decoder has to be a function.");
    ...
    const e3 = void 0 === t4.charset ? S.charset : t4.charset, o3 = void 0 === t4.duplicates ? S.duplicates : t4.duplicates;
    if ("combine" !== o3 && "first" !== o3 && "last" !== o3) throw new TypeError("The duplicates option must be either combine, first, or last");
    return { allowDots: void 0 === t4.allowDots ? true === t4.decodeDotInKeys || S.allowDots : !!t4.allowDots, allowEmptyArrays: "boolean" == typeof t4.allowEmptyArrays ? !!t4.allowEmptyArrays : S.allowEmptyArrays, allowPrototypes: "boolean" == typeof t4.allowPrototypes ? t4.allowPrototypes : S.allowPrototypes, allowSparse: "boolean" == typeof t4.allowSparse ? t4.allowSparse : S.allowSparse, arrayLimit: "number" == typeof t4.arrayLimit ? t4.arrayLimit : S.arrayLimit, charset: e3, charsetSentinel: "boolean" == typeof t4.charsetSentinel ? t4.charsetSentinel : S.charsetSentinel, comma: "boolean" == typeof t4.comma ? t4.comma : S.comma, decodeDotInKeys: "boolean" == typeof t4.decodeDotInKeys ? t4.decodeDotInKeys : S.decodeDotInKeys, decoder: "function" == typeof t4.decoder ? t4.decoder : S.decoder, delimiter: "string" == typeof t4.delimiter || (n3 = t4.delimiter, "[object RegExp]" === Object.prototype.toString.call(n3)) ? t4.delimiter : S.delimiter, depth: "number" == typeof t4.depth || false === t4.depth ? +t4.depth : S.depth, duplicates: o3, ignoreQueryPrefix: true === t4.ignoreQueryPrefix, interpretNumericEntities: "boolean" == typeof t4.interpretNumericEntities ? t4.interpretNumericEntities : S.interpretNumericEntities, parameterLimit: "number" == typeof t4.parameterLimit ? t4.parameterLimit : S.parameterLimit, parseArrays: false !== t4.parseArrays, plainObjects: "boolean" == typeof t4.plainObjects ? t4.plainObjects : S.plainObjects, strictNullHandling: "boolean" == typeof t4.strictNullHandling ? t4.strictNullHandling : S.strictNullHandling };
    var n3;
  })(e2);
...
function Z(t3) {
  if (!t3 && !globalThis.Ziggy && "undefined" == typeof Ziggy && !document.getElementById("ziggy-routes-json")) throw new Error("Ziggy error: missing configuration. Ensure that a `Ziggy` variable is defined globally or pass a config object into the useRoute hook.");
  return (e2, o2, n2, r2 = t3) => P(e2, o2, n2, r2);
}
export {
  U as ZiggyVue,
  P as route,
