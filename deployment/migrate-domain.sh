#!/bin/bash
# Domain Migration Script - To be executed on the server
# This script migrates from mygrownet.edulinkzm.com to mygrownet.com
...
if [ "$DNS_CHECK" = "138.197.187.134" ]; then
    ...
    echo "⚠️  DNS not fully propagated yet (got: $DNS_CHECK)"
