...
class SimpleUserPermissionTest extends TestCase
{
    use RefreshDatabase;

    /** @test */
    public function employee_user_account_linking()
    {
        // Create user account
    ...
    /** @test */
    public function role_based_access_control()
    {
        // Create permissions
    ...
    /** @test */
    public function employee_role_integration_service()
    {
        // Create test data
