...
class DesignStudioController extends Controller
{
    public function __construct(
        private readonly TemplateManagementService $templateService
    ) {}

    public function index(): Response
    {
        $systemTemplates = $this->getSystemTemplates();
        $customTemplates = $this->templateService->getUserTemplates(auth()->id());
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $this->templateService->createTemplate(auth()->id(), $validated);
    ...
    {
        $template = $this->templateService->getTemplateForEdit($id, auth()->id());
        ...
        return Inertia::render('QuickInvoice/DesignStudio/AdvancedBuilder', [
            'template' => $template,
            'defaultLayout' => null,
            'defaultFieldConfig' => $template['field_config'] ?? $this->getDefaultFieldConfig(),
        ]);
    }
    ...
    public function update(Request $request, int $id): RedirectResponse
    {
        ...
        $this->templateService->updateTemplate($id, auth()->id(), $validated);
    ...
    {
        try {
            $this->templateService->deleteTemplate($id, auth()->id());
    ...
    {
        $this->templateService->duplicateTemplate($id, auth()->id());
