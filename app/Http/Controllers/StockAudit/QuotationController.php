...
class QuotationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('StockAudit/Quotations/Index', [
    ...
    public function create(Request $request)
    {
        ...
        return Inertia::render('StockAudit/Quotations/Create', [
    ...
    {
        $quotation = $this->quotationService->getQuotationById($quotationId, session('stock_audit_company_id'));

        if (!$quotation) {
            abort(404);
        }

        return Inertia::render('StockAudit/Quotations/Show', [
