...
class GiftController extends Controller
{
    ...
    public function getLevelMembers(Request $request, int $level)
    {
        ...
        $members = \App\Infrastructure\Persistence\Eloquent\GrowNet\UserNetwork::where('referrer_id', $user->id)
            ->where('level', $level)
            ...
            ->map(function ($network) {
                ...
                return [
                    ...
                    'team_size' => \App\Infrastructure\Persistence\Eloquent\GrowNet\UserNetwork::where('referrer_id', $member->id)->count(),
                ];
            });
