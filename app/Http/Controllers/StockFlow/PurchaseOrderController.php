...
class PurchaseOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('StockFlow/Purchases/Index', [
            'orders' => $orders,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return Inertia::render('StockFlow/Purchases/Create', [
    ...
    {
        $order = $this->purchasingService->getOrderById($purchaseOrderId, session('stockflow_company_id'));

        if (!$order) {
            abort(404);
        }

        return Inertia::render('StockFlow/Purchases/Show', [
            'order' => $order->toArray(),
        ]);
    }
    ...
    public function suppliers(Request $request)
    {
        ...
        return Inertia::render('StockFlow/Suppliers/Index', [
            'suppliers' => $suppliers,
        ]);
    }
    ...
    public function report(Request $request)
    {
        ...
        return Inertia::render('StockFlow/Purchases/Report', [
