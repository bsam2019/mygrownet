...
class InvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('StockFlow/Invoices/Index', [
            'invoices' => $invoices,
    ...
    public function create(Request $request)
    {
        ...
        return Inertia::render('StockFlow/Invoices/Create', [
    ...
    {
        $invoice = $this->invoiceService->getInvoiceById($invoiceId, session('stockflow_company_id'));

        if (!$invoice) {
            abort(404);
        }

        return Inertia::render('StockFlow/Invoices/Show', [
