...
class ReceiptController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('StockFlow/Receipts/Index', [
            'receipts' => $receipts,
        ]);
    }
    ...
    {
        $receipt = $this->receiptService->getReceiptById($receiptId, session('stockflow_company_id'));

        if (!$receipt) {
            abort(404);
        }

        return Inertia::render('StockFlow/Receipts/Show', [
