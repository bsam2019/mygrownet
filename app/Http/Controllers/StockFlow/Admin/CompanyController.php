...
class CompanyController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('StockFlow/Admin/Companies/Index', [
            'companies' => $companies,
        ]);
    }
    ...
    {
        return Inertia::render('StockFlow/Admin/Companies/Create');
    }
    ...
    public function show(int $companyId)
    {
        ...
        return Inertia::render('StockFlow/Admin/Companies/Show', [
