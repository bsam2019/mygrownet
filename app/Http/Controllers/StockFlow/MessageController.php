...
class MessageController extends Controller
{
    ...
    public function inbox(Request $request)
    {
        ...
        return Inertia::render('StockFlow/Messages/Inbox', [
            'messages' => $messages,
        ]);
    }
    ...
    public function sent(Request $request)
    {
        ...
        return Inertia::render('StockFlow/Messages/Sent', [
            'messages' => $messages,
        ]);
    }
    ...
    public function show(Request $request, int $userId)
    {
        ...
        return Inertia::render('StockFlow/Messages/Show', [
    ...
    public function compose(Request $request)
    {
        ...
        return Inertia::render('StockFlow/Messages/Compose', [
            'users' => $users,
        ]);
    }
}
