...
class LevelAdvancementService
{
    ...
    protected function createPhysicalRewardRecord(User $user, string $level, string $rewardType): void
    {
        ...
        if (!class_exists(\App\Infrastructure\Persistence\Eloquent\GrowNet\PhysicalReward::class)) {
        ...
        \App\Infrastructure\Persistence\Eloquent\GrowNet\PhysicalReward::create([
            'user_id' => $user->id,
            'reward_type' => $rewardType,
