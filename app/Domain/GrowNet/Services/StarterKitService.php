...
use App\Infrastructure\Persistence\Eloquent\GrowNet\StarterKitUnlock;
...
class StarterKitService
{
    ...
    {
        try {
            $lgrQualificationService = app(\App\Domain\GrowNet\Application\Services\LgrQualificationService::class);
    ...
    {
        try {
            $receiptService = app(\App\Domain\GrowNet\Services\ReceiptService::class);
