...
const submit = () => {
    form.post(route('venture.sub.login'), {
...
<template>
    <VenturesGuestLayout>
        <Head title="Sign in - Venture Builder" />
        <div class="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div class="w-full max-w-md">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600 mt-1">Invest in promising ventures and grow your portfolio</p>
                </div>
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
                    <div class="mb-5 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                        <p class="text-xs text-amber-800 leading-relaxed">
                            Venture Builder uses your <strong>MyGrowNet</strong> account.
                            Already have one? Sign in below.
                            New here?
                            <Link :href="route('venture.sub.register')" class="text-amber-700 font-medium hover:underline">Create an account</Link>
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <Link :href="route('venture.sub.password.request')" class="text-xs text-amber-600 hover:text-amber-700 font-medium">Forgot?</Link>
                            </div>
                        ...
                        <div class="text-center text-sm text-gray-600 pt-2">
                            ...
                            <Link :href="route('venture.sub.register')" class="text-amber-600 hover:text-amber-700 font-medium">Sign up</Link>
                        </div>
                    </form>
                </div>
