...
import { ShieldCheckIcon, PhoneIcon, ClipboardDocumentIcon, BanknotesIcon } from '@heroicons/vue/24/outline';
    ...
    <MarketplaceLayout>
        <div class="max-w-2xl mx-auto px-4 py-12">
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <!-- Amount Display -->
                <div class="text-center p-6 bg-gradient-to-br from-orange-50 to-red-50 rounded-xl mb-6 border border-orange-100">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        >
                            <PhoneIcon class="h-6 w-6 mx-auto mb-2" 
                                :class="paymentMethod === 'mobile_money' ? 'text-orange-600' : 'text-gray-400'"
                                aria-hidden="true" />
                ...
                <div v-if="paymentMethod === 'mobile_money'" class="space-y-4 mb-6">
                    ...
                    <div class="p-4 bg-gray-50 rounded-lg text-sm space-y-3 text-gray-700">
                        <div class="flex gap-3">
                            ...
                            <p>Send <strong class="text-gray-900">{{ displayAmount }}</strong> via MTN MoMo or Airtel Money to the merchant</p>
                        </div>
                        <div class="flex gap-3">
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <button type="submit" :disabled="form.processing"
                            class="w-full py-3 bg-orange-500 text-white font-semibold rounded-lg hover:bg-orange-600 disabled:opacity-50 transition-colors">
