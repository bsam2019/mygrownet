                ...
                <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="px-6 py-5">
                            <div class="grid gap-4 sm:grid-cols-3">
                                <div>
                                    ...
                                    <input v-model="form.order_date" type="date" class="mt-1 block w-full rounded-lg border-0 bg-white px-3 py-2.5 text-sm text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600" />
                                    <p v-if="errors.order_date" class="mt-1 text-sm text-red-600">{{ errors.order_date }}</p>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Supplier</label>
                                    <select v-model="form.sa_supplier_id" class="mt-1 block w-full rounded-lg border-0 bg-white px-3 py-2.5 text-sm text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600">
                            ...
                            <div v-for="(lineItem, index) in lineItems" :key="index" class="border-t border-gray-100 pt-4">
                                <div class="mt-4 flex items-start gap-4">
                                    ...
                                    <div class="w-24">
                                        ...
                                        <input v-model.number="lineItem.quantity_ordered" type="number" step="0.01" min="0.01" class="mt-1 block w-full rounded-lg border-0 bg-white px-3 py-2.5 text-sm text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600" />
                                    </div>
                                    <div class="w-32">
                    ...
                    <div class="rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5 overflow-hidden">
                        <div class="flex items-center justify-end gap-3 px-6 py-4">
                            <Link :href="route('stockflow.sub.purchases.index')" class="text-sm font-medium text-gray-500 hover:text-gray-700 transition-colors">Cancel</Link>
