...
<template>
    <StockFlowLayout title="New Invoice">
            ...
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6 overflow-hidden rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-500 px-6 py-5 shadow-sm">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-lg font-semibold text-white">New Invoice</h1>
                            <p class="text-sm text-emerald-100">Generate a new invoice for a customer</p>
                        </div>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="px-6 py-5">
                            <div class="grid gap-4 sm:grid-cols-3">
                                <div>
                                    ...
                                    <input v-model="form.invoice_date" type="date" class="mt-1 block w-full rounded-lg border-0 bg-white px-3 py-2.5 text-sm text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600" />
                                    <p v-if="errors.invoice_date" class="mt-1 text-sm text-red-600">{{ errors.invoice_date }}</p>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Due Date</label>
                                    <input v-model="form.due_date" type="date" class="mt-1 block w-full rounded-lg border-0 bg-white px-3 py-2.5 text-sm text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">Payment Terms</label>
                                    <input v-model="form.payment_terms" type="text" placeholder="e.g. Net 30" class="mt-1 block w-full rounded-lg border-0 bg-white px-3 py-2.5 text-sm text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5 overflow-hidden">
                        <div class="flex items-center justify-end gap-3 px-6 py-4">
                            <Link :href="route('stockflow.sub.invoices.index')" class="text-sm font-medium text-gray-500 hover:text-gray-700 transition-colors">Cancel</Link>
