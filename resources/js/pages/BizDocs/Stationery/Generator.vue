...
const previewStationery = async () => {
    ...
    try {
        ...
        Swal.fire({
            ...
            text: error.message || 'An error occurred while generating preview',
        });
    } finally {
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center justify-between pt-4 border-t gap-3">
                            ...
                            <div class="flex items-center gap-3">
                                <button
                                    type="button"
                                    @click="previewStationery"
                                    :disabled="previewing || !form.template_id"
                                ...
                                >
                                    <svg v-if="previewing" class="animate-spin h-4 w-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
