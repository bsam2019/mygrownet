...
const steps = [
    { number: 1, label: 'Business Info', active: true, sectionId: 'section-business-info' },
    { number: 2, label: 'Bank Details',  active: true, sectionId: 'section-bank-details' },
    { number: 3, label: 'Complete',      active: true, sectionId: 'section-document-content' },
];
</script>

<template>
    <Head title="Business Profile Setup" />
    ...
    <AppLayout>
        <div class="min-h-screen bg-slate-50 flex items-start justify-center py-10 px-4">
            <div class="w-full max-w-5xl">
                ...
                <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden flex flex-col lg:flex-row">
                    ...
                    <aside class="lg:w-64 xl:w-72 bg-slate-900 flex-shrink-0 flex flex-col justify-between p-8">
                        <div>
                            ...
                            <h1 class="text-2xl font-bold text-white leading-snug mb-2">
                                Business<br />Profile Setup
                            </h1>
                            <p class="text-sm text-slate-400 leading-relaxed mb-10">
                                Set up once. Every document you create will use these details automatically.
                            </p>
                            ...
                            <nav class="space-y-1">
                                <button
                                    ...
                                    :key="step.number"
                                    type="button"
                                    @click="scrollToSection(step.sectionId)"
                                    class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors hover:bg-white/20 cursor-pointer"
                                    :class="step.active ? 'bg-white/10' : 'opacity-40'">
                                    <div
                                        class="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0"
                                        :class="step.active ? 'bg-blue-500 text-white' : 'bg-slate-700 text-slate-400'">
                                        {{ step.number }}
                                    </div>
                                    <span
                                        class="text-sm font-medium text-left"
                                        :class="step.active ? 'text-white' : 'text-slate-400'">
                                        {{ step.label }}
                                    </span>
                                </button>
                            </nav>
                    ...
                    <div class="flex-1 p-8 lg:p-10">
                        <form @submit.prevent="submit" class="space-y-8 max-w-2xl">
                            ...
                            <section id="section-business-info">
                            ...
                            <section id="section-bank-details">
                            ...
                            <section id="section-document-content">
                                <div class="flex items-center gap-3 mb-1">
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-slate-100">
                                <p class="text-xs text-slate-400">
                                    <span class="text-red-400 font-bold">*</span> Required fields
                                </p>
                                ...
                                <button
                                    ...
                                    <span v-if="!form.processing">Save & Continue</span>
                ...
                <!-- Bottom help links -->
                <div class="flex items-center justify-center gap-1 mt-5 text-xs text-slate-400">
                    <span>Need help?</span>
                    <a href="#" class="text-blue-600 hover:underline font-medium">View setup guide</a>
