...
import BizDocsGuestLayout from '@/layouts/BizDocsGuestLayout.vue';
...
const submit = () => {
    form.post(route('bizdocs.sub.login'), {
...
<template>
    <BizDocsGuestLayout>
        <Head title="Sign in - BizDocs" />
        <div class="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div class="w-full max-w-md">
                <div class="text-center mb-8">
                    <div class="mx-auto w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-lg mb-4">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
                    <div class="mb-5 p-3 bg-emerald-50 border border-emerald-200 rounded-lg">
                        <p class="text-xs text-emerald-800 leading-relaxed">
                            BizDocs uses your <strong>MyGrowNet</strong> account.
                            Already have one? Sign in below.
                            New here?
                            <Link :href="route('bizdocs.sub.register')" class="text-emerald-700 font-medium hover:underline">Create an account</Link>
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <Link :href="route('bizdocs.sub.password.request')" class="text-xs text-emerald-600 hover:text-emerald-700 font-medium">Forgot?</Link>
                            </div>
                        ...
                        <Button type="submit" class="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium py-5 shadow-sm" :disabled="form.processing">
                        ...
                        <div class="text-center text-sm text-gray-600 pt-2">
                            ...
                            <Link :href="route('bizdocs.sub.register')" class="text-emerald-600 hover:text-emerald-700 font-medium">Sign up</Link>
                        </div>
                    </form>
                </div>
                <div class="text-center mt-6">
                    <Link :href="route('bizdocs.sub.welcome')" class="text-sm text-gray-500 hover:text-gray-700">&larr; Back to home</Link>
                </div>
            </div>
        </div>
    </BizDocsGuestLayout>
