      ...
      <div class="p-6">
        ...
        <div class="mb-6">
          <div class="flex items-center gap-4">
            ...
            <div>
              <h1 class="text-2xl font-bold text-gray-900">Create Financial Report</h1>
              <p class="mt-1 text-sm text-gray-500">Add a new financial report for investors</p>
            </div>
          </div>
        </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div v-if="errors.report_type" class="mt-1 text-sm text-red-600">
                    {{ errors.report_type }}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Q3 2025"
                  />
                  <div v-if="errors.report_period" class="mt-1 text-sm text-red-600">
                ...
                <div>
                  ...
                  <input
                    ...
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                  <div v-if="errors.report_date" class="mt-1 text-sm text-red-600">
                    {{ errors.report_date }}
                  </div>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="150000"
                  />
                  <div v-if="errors.total_revenue" class="mt-1 text-sm text-red-600">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="120000"
                  />
                  <div v-if="errors.total_expenses" class="mt-1 text-sm text-red-600">
            ...
            <div class="bg-white rounded-lg shadow p-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="4"
                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="Additional context, explanations, or important notes about this reporting period..."
                ></textarea>
              </div>
            </div>
...
const form = reactive({
  ...
  total_expenses: null as number | null,
  cash_flow: null as number | null,
  growth_rate: null as number | null,
  total_members: null as number | null,
  active_members: null as number | null,
  monthly_recurring_revenue: null as number | null,
  churn_rate: null as number | null,
  notes: '',
});
...
const profitMargin = computed(() => {
  if (form.total_revenue && form.total_revenue > 0) {
    return (netProfit.value / form.total_revenue) * 100;
  }
  return 0;
});
...
const submitForm = () => {
  ...
  router.post(route('admin.financial-reports.store'), form, {
    onFinish: () => {
