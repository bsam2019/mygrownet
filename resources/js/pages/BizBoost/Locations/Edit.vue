...
const form = useForm({
    ...
    business_hours: props.location.business_hours || defaultHours(),
    is_active: props.location.is_active,
});

const submit = () => {
    form.put(`/bizboost/locations/${props.location.id}`);
};
</script>

<template>
    <Head title="Edit Location - BizBoost" />
    <BizBoostLayout title="Edit Location">
                ...
                <form @submit.prevent="submit" class="space-y-8">
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        <FormCheckbox
                            ...
                            description="Active locations are visible on your business page"
                        />
                    </div>
