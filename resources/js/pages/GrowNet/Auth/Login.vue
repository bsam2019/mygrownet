...
const submit = () => {
    form.post(route('grownet.sub.login'), {
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <Link :href="route('grownet.sub.password.request')" class="text-xs text-indigo-600 hover:text-indigo-700 font-medium">Forgot?</Link>
                            </div>
