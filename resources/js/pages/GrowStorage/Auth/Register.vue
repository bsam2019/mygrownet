...
const submit = () => {
    form.post(route('growstorage.sub.register'), {
...
<template>
    <GrowStorageGuestLayout>
        <Head title="Sign up - GrowStorage" />
        <div class="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div class="w-full max-w-md">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600 mt-1">Secure cloud storage for your business</p>
                </div>
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div class="text-center text-sm text-gray-600 pt-2">
                            ...
                            <Link :href="route('growstorage.sub.login')" class="text-cyan-600 hover:text-cyan-700 font-medium">Sign in</Link>
                        </div>
                    </form>
                    <div class="mt-6 pt-4 border-t border-gray-100">
                        <p class="text-xs text-gray-500 text-center leading-relaxed">
                            By creating an account, you agree to our
                            <Link :href="route('growstorage.sub.terms')" class="text-cyan-600 hover:text-cyan-700">Terms of Service</Link>
                            and
                            <Link :href="route('growstorage.sub.privacy')" class="text-cyan-600 hover:text-cyan-700">Privacy Policy</Link>.
