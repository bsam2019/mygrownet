...
const applyFilters = debounce(() => {
    router.get(route('employee.portal.delegated.users.index'), {
    ...
    <EmployeePortalLayout>
        ...
        <div class="max-w-6xl mx-auto space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div class="p-2 bg-purple-100 rounded-lg">
                        <UsersIcon class="h-6 w-6 text-purple-600" aria-hidden="true" />
                    </div>
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Users</h1>
                        <p class="text-sm text-gray-500">View and search member accounts</p>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="user in users.data" :key="user.id" class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <Link
                                        :href="route('employee.portal.delegated.users.show', user.id)"
                            ...
                            <tr v-if="users.data.length === 0">
                                <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                    <UsersIcon class="h-12 w-12 mx-auto mb-3 text-gray-300" aria-hidden="true" />
                                    <p>No users found</p>
                ...
                <!-- Pagination -->
                <div v-if="users.last_page > 1" class="px-6 py-4 border-t border-gray-200 flex items-center justify-between">
