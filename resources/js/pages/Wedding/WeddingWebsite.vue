<template>
  ...
  <div class="min-h-screen relative bg-white overflow-hidden">
    ...
    <main class="min-h-screen">
      <!-- Home Tab -->
      <section v-show="activeTab === 'home'" id="home" class="pt-2 pb-8 md:py-12 text-center bg-white">
        <div class="max-w-4xl mx-auto px-4">
          ...
          <!-- Hero Image -->
          <div class="relative w-full mx-auto mb-8 md:mb-10 -mx-4 md:mx-0 md:max-w-6xl lg:max-w-7xl">
          ...
          <div class="max-w-md mx-auto">
            <h2 class="text-sm font-normal text-gray-500 mb-6 tracking-[0.2em] uppercase">Wedding Ceremony</h2>
            
            <div class="space-y-2 text-gray-400 text-sm leading-relaxed font-light italic">
      ...
      <!-- Our Story Tab -->
      <section v-show="activeTab === 'story'" id="story" class="py-12 md:py-20 bg-gradient-to-b from-white via-gray-50/30 to-white">
      ...
      <!-- Wedding Program Tab -->
      <section v-show="activeTab === 'program'" id="program" class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4">
      ...
      <!-- Q&A Tab -->
      <section v-show="activeTab === 'qa'" id="qa" class="py-8 bg-white">
      ...
      <!-- Travel Tab -->
      <section v-show="activeTab === 'travel'" id="travel" class="py-16 bg-white">
        <div class="max-w-3xl mx-auto px-4">
          <div class="text-center mb-16">
      ...
      <!-- RSVP Tab -->
      <section v-show="activeTab === 'rsvp'" id="rsvp" class="py-16 bg-white">
    ...
    <section class="py-16 bg-white">
      <div class="max-w-4xl mx-auto px-4 text-center">
        <!-- Elegant Monogram -->
        <div class="mb-4">
          <h2 class="text-4xl md:text-5xl font-light text-gray-400 tracking-[0.2em] font-serif">
            {{ getMonogramInitials() }}
          </h2>
          <div class="w-32 h-px bg-gray-300 mx-auto mt-4"></div>
        </div>
        
        <p class="text-sm text-gray-400 tracking-[0.15em] mb-12">{{ formatMonogramDate(weddingEvent.wedding_date) }}</p>
