        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                    <span
                        v-if="plan.popular"
                        class="absolute -top-3 left-1/2 -translate-x-1/2 text-xs font-bold bg-emerald-600 text-white px-3 py-1 rounded-full"
                    >
                        RECOMMENDED
                    </span>
                    ...
                    <div v-if="canUpgradeTo(plan.key)" class="mt-6">
                        <a
                            ...
                            class="block w-full text-center py-2.5 rounded-xl font-semibold text-white hover:opacity-90 transition"
