...
const submit = () => {
    ...
    router.post(route('stock-audit.quotations.store'), {
        ...form.value,
...
<template>
    <StockAuditLayout title="New Quotation">
        ...
        <div class="min-h-screen bg-gray-50 py-6">
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                <div class="mb-6">
                    ...
                    <h1 class="mt-2 text-2xl font-bold text-gray-900">New Quotation</h1>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="rounded-xl bg-white p-6 shadow-sm">
                        ...
                        <div class="mt-4 grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input v-model="form.quotation_date" type="date" class="mt-1 w-full rounded-lg border-gray-300 focus:border-emerald-500 focus:ring-emerald-500" />
                    ...
                    <div class="rounded-xl bg-white p-6 shadow-sm">
                        <h2 class="text-lg font-semibold text-gray-900">Additional</h2>
                        <div class="mt-4 grid gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Terms & Conditions</label>
                                <textarea v-model="form.terms_conditions" rows="2" class="mt-1 w-full rounded-lg border-gray-300 focus:border-emerald-500 focus:ring-emerald-500"></textarea>
                            </div>
                            <div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <Link :href="route('stock-audit.quotations.index')" class="text-sm text-gray-600 hover:text-gray-800">Cancel</Link>
                    </div>
                </form>
            </div>
        </div>
