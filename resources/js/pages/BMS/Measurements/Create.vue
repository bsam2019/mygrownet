...
function submit() {
    form.post(route('bms.measurements.store'));
}
</script>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="flex items-center justify-end gap-3">
                <Link :href="route('bms.measurements.index')" class="px-4 py-2 text-sm text-gray-600 hover:text-gray-800 transition">Cancel</Link>
                <button
                    type="submit"
