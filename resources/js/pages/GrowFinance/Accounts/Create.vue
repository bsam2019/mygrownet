...
const updateNormalBalance = () => {
    const debitNormal = form.type === 'asset' || form.type === 'expense';
    form.normal_balance = debitNormal ? 'debit' : 'credit';
};

const filteredParents = computed(() => {
    return props.parentAccounts.filter(a => a.type === form.type);
});
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">
                            Defaults to {{ form.type === 'asset' || form.type === 'expense' ? 'Debit' : 'Credit' }} for {{ form.type }} accounts
                        </p>
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="0.00"
                        />
                        <p v-if="form.errors.opening_balance" class="mt-1 text-sm text-red-600">{{ form.errors.opening_balance }}</p>
                    </div>
                </div>
