        ...
        <div class="px-4 py-4 pb-6">
            ...
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm">{{ quotation.quotation_number }}</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div class="bg-white rounded-2xl shadow-sm p-4">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button type="button" @click="addItem" class="text-sm text-emerald-600 font-medium">
                            + Add Item
                        </button>
                    </div>
...
const submit = () => {
    ...
    router.put(route('growfinance.quotations.update', props.quotation.id), form, {
