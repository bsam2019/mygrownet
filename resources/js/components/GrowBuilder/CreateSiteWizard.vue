...
// Watch for name changes and auto-generate subdomain in real-time (no hyphens)
watch(() => form.name, (newName) => {
    console.log('Name changed to:', newName); // Debug log
    const autoGenerated = newName
        .toLowerCase()
        .replace(/[^a-z0-9]+/g, '')
        .substring(0, 63);
    
    console.log('Auto-generated subdomain:', autoGenerated); // Debug log
                    ...
                    <div class="p-5 overflow-y-auto flex-1">
                        ...
                        <div v-if="currentStep === 1" class="space-y-5">
                            ...
                            <div>
                                ...
                                <p v-else class="mt-1.5 text-xs text-gray-500">Only lowercase letters and numbers</p>
                            </div>
