            ...
            <nav>
                ...
                <Link
                    ...
                    :class="[
                        ...
                        isUrlActive(['/workspace', '/']) ? 'text-blue-600 bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-600' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800',
