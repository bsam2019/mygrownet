<template>
    <div class="py-12 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-gradient-to-r from-blue-500 to-blue-700 rounded-lg shadow-xl p-8 text-center">
          <h2 class="text-3xl font-bold text-white mb-4">Ready to Start Your Growth Journey?</h2>
          <p class="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
            Access training, business tools, marketplace products, and venture opportunities. 
          ...
          <div class="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link :href="route('bizboost.welcome')" class="inline-flex items-center justify-center px-8 py-3 border-2 border-white text-white font-bold rounded-full hover:bg-white/10 hover:scale-105 transition-all duration-300">
              Try Business Apps
            </Link>
          </div>
          <div class="mt-6 text-sm text-blue-200">
            Training & mentorship • Business tools • Marketplace • Venture opportunities
          </div>
        </div>
      </div>
    </div>
