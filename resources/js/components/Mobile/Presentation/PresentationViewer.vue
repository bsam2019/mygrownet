<template>
  ...
  >
    ...
    <!-- Top Control Bar - Overlaid -->
    <div class="absolute top-0 left-0 right-0 flex items-center justify-between px-4 py-3 z-50 safe-area-top">
      <!-- Left: Share Button -->
      <button
    ...
    <!-- Bottom Navigation Bar - Overlaid -->
    <div class="absolute bottom-0 left-0 right-0 px-4 py-3 z-50 safe-area-bottom">
