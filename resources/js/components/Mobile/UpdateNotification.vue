<template>
  <Transition name="slide-up">
    <div
      ...
      class="fixed bottom-40 md:bottom-8 left-4 right-4 md:left-auto md:right-8 md:w-96 z-[99999] bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg shadow-2xl p-4"
