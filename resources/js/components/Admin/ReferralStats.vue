<template>
  <div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
      <h1 class="text-2xl font-semibold text-gray-900">Referral Commission Management</h1>
      <button
...
import { UserGroupIcon, UserIcon, CurrencyDollarIcon, ClockIcon } from '@heroicons/vue/24/outline'
