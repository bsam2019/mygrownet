...
onMounted(() => {
    ...
    const dismissed = localStorage.getItem('growfinance-pwa-dismissed');
    if (!dismissed) {
        setTimeout(() => {
...
const dismissPrompt = () => {
    showPrompt.value = false;
    localStorage.setItem('growfinance-pwa-dismissed', 'true');
};
</script>
            ...
            <div class="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 px-4 py-3 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-white font-semibold">Install GrowFinance</span>
                    </div>
                    <button 
                        @click="dismissPrompt"
                ...
                <div class="p-4">
                    <p class="text-sm text-gray-600 mb-4">
                        Install GrowFinance on your device for quick access to your business finances.
                    </p>
                    ...
                    <template v-else>
                        ...
                        <div v-else class="space-y-3">
                            <p class="text-sm text-gray-500">
                                Add GrowFinance to your home screen for quick access.
                            </p>
