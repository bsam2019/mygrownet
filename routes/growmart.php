...
| - Admin panel for product/category/warehouse management
| - Customer-facing storefront
|
*/

// Customer frontend (public)
Route::prefix('growmart')->name('growmart.')->group(function () {
...
Route::prefix('growmart')->name('growmart.')->middleware('auth')->group(function () {
